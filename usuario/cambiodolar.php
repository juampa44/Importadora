  ...
  <div class="contenedor">
	...
	<table>
		...
		<tr>
			...
			<td>&nbsp;&nbsp;</td>
			<td>
				<input type="text" id="taza" name="taza" placeholder="Escriba la Taza" required autofocus>
			</td>
		</tr>
	</table>	
		<br>
	...
	<table>
		<tr>
			<td align="center" width="150"><a href="herramientas.php"><img src="../imagenes/regresar.png" width="50"></a></td>
			<td align="center" width="150"><a href="logout.php"><img src="../imagenes/salir.png" width="50"></a></td>
		</tr>
		<tr>
			<td align="center" width="150"><a href="herramientas.php">Regresar</a></td>

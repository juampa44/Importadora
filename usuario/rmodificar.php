...
$user=$_POST['user'];
$nivel=$_POST['nivel'];
mysqli_query($link, "UPDATE usuario SET nivel = '$nivel' WHERE user = '$user'");

$user=$_POST['user2'];
$pass=$_POST['pass'];
mysqli_query($link, "UPDATE usuario SET pass = '$pass' WHERE user = '$user'");
...
<body>
  <div class="contenedor">
	...
	<hr size="10">
	<h2><font color=red>El usuario fue modificado con exitos.</font></h2>

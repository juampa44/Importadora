...
$nivel=$_POST['nivel'];
mysqli_query($link, "INSERT INTO usuario(nombre, apellido, user, pass, email, telefono, nivel) VALUES ('$nombre', '$apellido', '$user', '$pass', '$email', '$telefono', '$nivel')");
...
<body>
  <div class="contenedor">
	...
	<br><br>
	<h2><font color=red>El usuario fue registrado con exitos.</font></h2>

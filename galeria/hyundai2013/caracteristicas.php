	...
	<section class="main">
		...
		<aside class="sec2">
			<p><article class="efecto">
				<h2>Hyundai Elantra GLS 2013</h2>
				<ul>
					<li>Version GLS</li>
        			...
        			<li>Frenos ABS</li>
        			<li class="precio">Q. 60,000.00</li>
        		</ul>
        			<span class="section__titulo"><a href="https://www.copart.com/lot/22496437/" id="ag" class="hvr-underline-from-center" target="_blank">Click aqui para ver detalles en Copart</a></span>
        			<br><br>
